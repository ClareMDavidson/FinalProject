...
<div class="blogPost">
    ...
    foreach($multiPost->getMultiPost() as $posts) {?>
        ...
        <p><?php echo $posts->getShortContent().'...' . '<br><div class="blogLink"><a href="index.php?controller=blogPost&action=view&blogPostID='.$posts->getID().'"><h6><u>View full post</u></h6></a></div>'; ?></p>
