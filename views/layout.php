            ...
            <h2 text-decoration="none" color="#F8FFF4">
                ...
                <h2 text-decoration="none" color="#F8FFF4">
                    ...
                    <div class="dropdown-content">
                        <a href="?controller=pages&action=archive&month=01" id="01">January 2018</a>
                        <a href="?controller=pages&action=archive&month=02" id="01">February 2018</a>
                        <a href="?controller=pages&action=archive&month=03" id="01">March 2018</a>
                        <a href="?controller=pages&action=archive&month=04" id="01">April 2018</a>
                        <a href="?controller=pages&action=archive&month=05" id="01">May 2018</a>
                        <a href="?controller=pages&action=archive&month=06" id="01">June 2018</a>
                        <a href="?controller=pages&action=archive&month=07" id="01">July 2018</a>
                        <a href="?controller=pages&action=archive&month=08" id="01">August 2018</a>
                        <a href="?controller=pages&action=archive&month=09" id="01">September 2018</a>
                        <a href="?controller=pages&action=archive&month=01" id="10">October 2018</a>
                        <a href="?controller=pages&action=archive&month=01" id="11">November 2018</a>
                        <a href="?controller=pages&action=archive&month=01" id="12">December 2018</a>
                    </div>
            </div>
            <h2 text-decoration="none" color="#F8FFF4">
