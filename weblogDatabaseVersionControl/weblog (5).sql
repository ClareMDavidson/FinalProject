...
--
-- Host: localhost
-- Generation Time: Apr 22, 2018 at 04:01 PM
...
CREATE TABLE `blogPost` (
  ...
  `wowed` int(11) NOT NULL DEFAULT '0',
  `angered` int(11) NOT NULL DEFAULT '0',
...
(15, 3, 'MaryBarry', 'mary.barry@gmail.com', 'Ummmm you definitely need to speak to your landlord, if you didn\'t know it was an old asylum when you moved in then it\'s a bit unfair....', '20:19:00', '2018-01-19', 1, 'Yes'),
...
(19, 4, 'KatyaZam', 'katya.zam@gmail.com', 'Does your block of flats have a caretaker? Maybe get them to investigate. Sounds disgusting.', '18:53:00', '2018-01-26', 1, 'Yes'),
...
(33, 7, 'JabbaHutt', 'jabbahutt@starwars.com', 'Look I really think you need to just move out, if you didn\'t have any weirdness on your break then it\'s definitely something in that building- probably a weird neighbour. Could you stop with a friend? your sister?', '09:06:00', '2018-02-15', 1, 'Yes'),
(34, 7, 'MaryBarry', 'mary.barry@gmail.com', 'OK @KyotoK I see what you\'re trying to do and what you are, you stay in your lane. Some people are not intelligent enough to have truths revealed to them.', '11:40:00', '2018-02-15', 1, 'Yes'),
(35, 8, 'TheBexter', 'becky@gmail.com', 'Ok, that\'s weird. Time to move. Something is up. I did a quick google of your place and there are some records of some strange things happening in the days it was a hospital. Even if there is no \'ghost\' or \'satanists\' there\'s a bad energy to the place and you won\'t be settled or happy there with all these memories of sleepless nights and fear. Take care of yourself. x', '19:33:00', '2018-02-15', 2, 'Yes'),
(36, 8, 'JabbaHutt', 'jabbahutt@starwars.com', 'I think you should get one of those webcams that you can stream to your phone and set it up outside your flat door, then you will be able to see if someone is messing with you. They\'re only about Â£20 on amazon.', '12:17:00', '2018-02-16', 1, 'Yes'),
(37, 8, 'KatyaZam', 'katya.zam@gmail.com', 'I say you should get a friend to stop over, see if any weirdness happens then- then you\'ll have a witness.', '13:34:00', '2018-02-16', 2, 'Yes'),
(38, 8, 'Jumanji99', 'jermaine.taylor@google.com', 'Just stop trolling us all and go back to your sad life. This is so obviously fake guys... what a joker.', '19:34:00', '2018-02-16', -4, 'Yes');
...
(1, 'ClareDavidson', 'password123'),
(2, 'BLOGGER', 'password123'),
(3, 'ScaredSarah', 'password123');
...
--
ALTER TABLE `comment`
  MODIFY `commentPostID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `blogPost`
  ADD CONSTRAINT `blogpost_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `users` (`users_id`);
